...
export function PhoneFrame({ src, alt, className }: Props) {
  return (
    <div
      className={`relative mx-auto w-[260px] rounded-[2.6rem] border-[10px] border-[#0b0b12] bg-[#0b0b12] shadow-[0_40px_90px_-25px_rgba(0,0,0,0.65)] ring-1 ring-white/10 ${className ?? ''}`}
    >
