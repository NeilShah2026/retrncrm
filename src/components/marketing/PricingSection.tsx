...
const TIERS: Tier[] = [
  {
    ...
    features: [
      ...
      'Tags and filters',
      'Last-contact tracking and reconnect suggestions',
  ...
  },
  {
    ...
    subhead: 'For students with a verified .edu email',
    ...
    cta: 'Verify .edu',
    ctaMicro: 'Requires a verified .edu email. Free for Babson students with @babson.edu.',
  ...
  },
  {
    ...
    subhead: 'For everyone else — no .edu needed',
    featuresLead: 'Everything in Student, plus',
    features: [
      'Everything the Student plan includes',
